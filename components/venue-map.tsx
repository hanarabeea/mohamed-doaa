...
export default function VenueMap() {
  ...
  // Google Maps URL for Sea Garden Hall
  const googleMapsUrl = "https://maps.app.goo.gl/uUJWM7VpyM8A2yReA";
        ...
        <div className="relative group">
          ...
          <div className="mt-6 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-2">
              {isRTL ? 'قاعه سي جاردن' : 'Sea Garden Hall'}
            </h3>
            <div className="text-muted-foreground text-sm sm:text-base mb-3 space-y-1">
              {isRTL ? (
                <>
                  <div>نادي 6 اكتوبر، الأنفوشي، بحري</div>
                </>
              ) : (
                <>
                  <div>6 October Club, Al Anfushi, Bahari</div>
                </>
              )}
            </div>
